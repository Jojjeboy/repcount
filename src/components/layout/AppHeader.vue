  ...
  >
    <div class="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
      ...
      >
        ...
        <router-link to="/" class="flex items-center justify-center gap-2 mx-4 flex-1 lg:flex-none">
          <img
          ...
          />
          <span class="text-xl font-bold text-gray-800 dark:text-white truncate">
            {{ t('brand.name') }}
          </span>
        </router-link>
        <UserMenu />
